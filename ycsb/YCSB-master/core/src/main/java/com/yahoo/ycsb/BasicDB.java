...
public class BasicDB extends DB
{
	...
	public int read(String table, String key, Set<String> fields, HashMap<String,ByteIterator> result)
	{
		...
		if (verbose)
		{
			System.out.print("READ ARGY!!!!!!!"+table+" "+key+" [ ");
			if (fields!=null)
			{
				for (String f : fields)
				{
	...
	public int scan(String table, String startkey, int recordcount, Set<String> fields, Vector<HashMap<String,ByteIterator>> result)
	{
		...
		if (verbose)
		{
			System.out.print("SCAN ARGY!!!!!"+table+" "+startkey+" "+recordcount+" [ ");
			if (fields!=null)
			{
				for (String f : fields)
				{
	...
	public int update(String table, String key, HashMap<String,ByteIterator> values)
	{
		...
		if (verbose)
		{
			System.out.print("UPDATE  ARGY!!!!!"+table+" "+key+" [ ");
			if (values!=null)
			{
	...
	{
		System.out.print("INSERT  ARGY!!!!!"+table+" "+key+" [ ");
		delay();
	...
	public int delete(String table, String key)
	{
		...
		if (verbose)
		{
			System.out.println("DELETE  ARGY!!!!!"+table+" "+key);
		}
